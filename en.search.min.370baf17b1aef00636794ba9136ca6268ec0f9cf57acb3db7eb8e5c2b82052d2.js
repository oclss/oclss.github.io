...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2699dfaf9a08fa87c4140e104d3a2ea9d8cf1bdb1b2c204e602b6eed8855a996.js',function(){input.required=false;search();});}
