...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ed7908186faa6a1d2f5daca69f05bc3f7544e0fb70fee1dd098afb3bbf07dfe9.js',function(){input.required=false;search();});}
