...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.652c0a0886de15bee31d9cc0f5cf59a840fc81d46db4993f04d0b493cc94e9c5.js',function(){input.required=false;search();});}
