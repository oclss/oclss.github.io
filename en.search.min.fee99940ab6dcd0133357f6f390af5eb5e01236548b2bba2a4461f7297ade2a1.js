...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.63733fc1614505ea890fc787f4523a6a111754f52425a8ece52b31748fb8dd8d.js',function(){input.required=false;search();});}
